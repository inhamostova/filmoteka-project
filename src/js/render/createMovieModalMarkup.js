...
<p class="modal__info"><span class="modal__info__data">Vote / Votes</span><span class="modal__info__value"><span class="vote">${sliceNum(vote_average)}</span> / <span class="votes">${vote_count}</span></span></p>
    <p class="modal__info"><span class="modal__info__data popularity">Popularity</span><span class="modal__info__value">${sliceNum(popularity)}</span></p>
    ...
    <ul class="modal-btn-list">
      <li class="modal-btn-list__item"><button class="modal__btn" data-btn="watched" type="button">add to Watched</button></li>
      <li class="modal-btn-list__item"><button class="modal__btn" data-btn="queue" type="button">add to queue</button></li>
    </ul>
</div>`;
}
